    ...
    useEffect(() => {
        const fetchPosts = async () => {
            ...
            try {
                ...
                const politicsPost = allPosts.filter(post => post.categories?.some(sub => sub.title == "Sports"));
                            ...
                            <div className={styles.post} key={index}>
                                ...
                                <div className={styles.post_txts}>
                                    ...
                                    <div className={styles.post_category}>
                                        <Link className={styles.Scale} to={`/category/${post.subcategories?.map(category => category.slug.current)}`}>
                                            {post.subcategories ? (
                                    ...
                                    <div className={` ${styles.Aouthor_date} ${styles.Scale}`}>
